...
public class ArriveScenario {
   ...
   * - Write a controller for "car1" that uses the "Arrive" steerig behavior to
   * arrive to
   * a given marker.
   * - To make sure it works, test your controller by placing the marker in
   * different positions
   * in the map.
   */
  ...
  public static void main(String args[]) throws Exception {
    ...
    // using arrive steering behavior
